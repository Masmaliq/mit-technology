...
type DashboardHeroContent = typeof dashboardHero;

export default function DashboardHero({ content = dashboardHero }: { content?: DashboardHeroContent }) {
  return (
    <section className="overflow-hidden rounded-[2rem] border border-white bg-gradient-to-br from-white via-blue-50/70 to-violet-50 p-6 shadow-[0_24px_80px_rgba(15,23,42,0.08)] sm:p-8">
      <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <AdminActionLink action={content.actions[1]} className="rounded-full bg-blue-600 px-5 py-3 text-sm font-bold text-white shadow-xl shadow-blue-600/20 transition hover:bg-blue-700">
            {content.actions[1]}
          </AdminActionLink>
        </div>
      </div>
