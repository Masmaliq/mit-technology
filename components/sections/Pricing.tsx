  ...
  return (
    <section id="pricing" aria-label="Pricing" className="bg-white py-28">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <StaggerContainer className="mt-16 grid gap-5 lg:grid-cols-2">
          {items.length > 0 ? (
            items.map((item) => {
              ...
              return (
                <StaggerItem className="h-full" key={item.slug || item.title}>
                  <ScaleIn className="h-full">
                    <article
                      className={`group flex min-h-full flex-col rounded-[1.75rem] border bg-white p-7 shadow-[0_22px_80px_rgba(15,23,42,0.055)] transition duration-[350ms] ease-out hover:-translate-y-2.5 hover:scale-[1.015] hover:shadow-[0_36px_110px_rgba(15,23,42,0.12)] ${
                        item.featured
                          ? "border-[#9A7B38]/35 ring-1 ring-[#9A7B38]/15 hover:border-[#9A7B38]/55"
