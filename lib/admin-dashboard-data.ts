...
export const settingsControlPanel = {
  ...
  summary: [
    ...
    { label: "Lingkungan", value: "Local", tone: "amber" },
    { label: "Status Sistem", value: "Stable", tone: "emerald" },
  ],
  generalSettings: [
  ...
  frameworkConfiguration: [
    ...
    ["Module Routes", "Ready"],
    ["Sistem Visual", "Active"],
    ["Sistem Motion", "Active"],
  ],
  systemReadiness: [
    ["Dashboard", "Ready"],
    ["Modul Konten", "Ready"],
